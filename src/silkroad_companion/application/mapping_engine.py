...
class MappingEngine:
    ...
    def toggle_picker_mode(self) -> None:
        ...
        if self._picker_mode:
            print("Klicke mit der Maus im Silkroad-Fenster oder drücke 'C', um die aktuelle Cursor-Position zu capturen.", flush=True)
        print("-----------------------------------\n", flush=True)
    ...
    def _print_coordinates(self, abs_x: int, abs_y: int, window_info: "WindowInfo") -> None:
        ...
        # Prüfung ob Position im Fenster liegt
